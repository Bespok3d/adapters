...
from .integration import KlipperIntegration
from .klipper_vocab import RESTART_DISPLAY, RESTART_KLIPPER, RESTART_MOONRAKER
...
class KlipperPrinterJinni(
    KlipperRealization, KlipperFacts, KlipperProbing, KlipperHealth, KlipperIntegration, Jinni,
):
